...
class CaptureAndWashProcessUDFs(BaseModel):
    ...
    hybridization_time: Optional[float] = Field(..., alias="Total hybridization time (h)")
    lot_nr_h20_capture_and_wash: Optional[str] = Field(..., alias="Nuclease free water")
    capture_and_wash_method: Optional[str] = Field(..., alias="Method document")
