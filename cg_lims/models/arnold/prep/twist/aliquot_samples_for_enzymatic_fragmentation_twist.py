...
class AliquotSamplesForEnzymaticFragmentationProcessUdfs(BaseModel):
    ...
    aliquot_samples_library_preparation_method_2: Optional[str] = Field(alias="Method document 2")
    aliquot_samples_library_preparation_method_1: Optional[str] = Field(alias="Method document 1")
    lot_nr_h2o_aliquot_samples_fragmentation: Optional[str] = Field(alias="Nuclease free water")
