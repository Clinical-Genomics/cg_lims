...
class PoolingAndCleanUpCovProcessUDFS(BaseModel):
    pooling_method: Optional[str] = Field(..., alias="Method document (pooling)")
    clean_up_method: Optional[str] = Field(..., alias="Method document (Clean-up)")
    lot_nr_beads_clean_up: Optional[str] = Field(..., alias="Purification beads")
    lot_nr_etoh_clean_up: Optional[str] = Field(..., alias="Ethanol")
    lot_nr_h2o_clean_up: Optional[str] = Field(..., alias="Nuclease-free water")
    lot_nr_resuspension_buffer_clean_up: Optional[str] = Field(..., alias="Resuspension buffer")
