...
from cg_lims.EPPs.udf.calculate.sum_missing_reads_in_pool import sum_reads
...
def test_sum_reads_pool(lims):
    ...
    # WHEN running sum_reads
    passed_artifacts, failed_artifacts = sum_reads(artifacts=artifacts)
